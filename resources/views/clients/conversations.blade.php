                            ...
                            @foreach ($listMessage as $item)
                                ...
                                @else
                                    <li class="chat-group">
                                        <div class="chat-body">
                                            <div>
                                                <h6 class="d-inline-flex">{{ $item->user->name }}</h6>
                                            </div>
...
<script>
    ...
    function scrollToBottom() {
        ...
        chatList.scrollToBottom = chatList.scrollHeight;
    }

    // Gọi hàm `scrollToBottom()` mỗi khi có tin nhắn mới
    scrollToBottom();
</script>
@endsection